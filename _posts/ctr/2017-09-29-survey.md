...
- GBDT + LR, 2014
![](/styles/images/ctrfigs/fb-gbdt-lr.png){:height="300"}
...
![](/styles/images/ctrfigs/FNN.png){:height="300"}
![](/styles/images/ctrfigs/SNN.png){:height="300"}
...
![](/styles/images/ctrfigs/PNN.png){:height="300"}
